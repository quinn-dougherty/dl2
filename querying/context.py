...
def get_context(args):
    ...
    M_NN1 = mnist.Net1()
    M_NN1.load_state_dict(
        torch.load(
            os.path.join(curr_dir, "models/mnist/mnist_1.pt"), map_location="cpu"
        )
    )
    ...
    M_NN2 = mnist.Net2()
    M_NN2.load_state_dict(
        torch.load(
            os.path.join(curr_dir, "models/mnist/mnist_2.pt"), map_location="cpu"
        )
    )
    ...
    mnistD.load_state_dict(
        torch.load(
            os.path.join(curr_dir, "models/dcgan/mnist/netD_epoch_13.pth"),
            map_location="cpu",
        )
    )
    ...
    mnistG.load_state_dict(
        torch.load(
            os.path.join(curr_dir, "models/dcgan/mnist/netG_epoch_13.pth"),
            map_location="cpu",
        )
    )
    ...
    FM_NN1 = mnist.Net1()
    FM_NN1.load_state_dict(
        torch.load(
            os.path.join(curr_dir, "models/mnist/fashionmnist_1.pt"), map_location="cpu"
        )
    )
    FM_NN1.eval()

    FM_NN2 = mnist.Net2()
    FM_NN2.load_state_dict(
        torch.load(
            os.path.join(curr_dir, "models/mnist/fashionmnist_2.pt"), map_location="cpu"
        )
    )
    FM_NN2.eval()
    ...
    fmnistD.load_state_dict(
        torch.load(
            os.path.join(curr_dir, "models/dcgan/fashionmnist/netD_epoch_13.pth"),
            map_location="cpu",
        )
    )
    ...
    fmnistG.load_state_dict(
        torch.load(
            os.path.join(curr_dir, "models/dcgan/fashionmnist/netG_epoch_13.pth"),
            map_location="cpu",
        )
    )
    ...
    state = torch.load(
        os.path.join(curr_dir, "models/cifar/checkpoint/vgg16.pt"), map_location="cpu"
    )
    ...
    state = torch.load(
        os.path.join(curr_dir, "models/cifar/checkpoint/resnet18.pt"),
        map_location="cpu",
    )
    state_dict = dict([(a.replace("module.", ""), b) for a, b in state["net"].items()])
    ...
    cifarD.load_state_dict(
        torch.load(
            os.path.join(curr_dir, "models/dcgan/cifar10/netD_epoch_13.pth"),
            map_location="cpu",
        )
    )
    ...
    cifarG.load_state_dict(
        torch.load(
            os.path.join(curr_dir, "models/dcgan/cifar10/netG_epoch_13.pth"),
            map_location="cpu",
        )
    )
    ...
    state = torch.load(
        os.path.join(curr_dir, "models/gtsrb/checkpoint/vgg16.pt"), map_location="cpu"
    )
    state_dict = dict([(a.replace("module.", ""), b) for a, b in state["net"].items()])
    ...
    state = torch.load(
        os.path.join(curr_dir, "models/gtsrb/checkpoint/resnet18.pt"),
        map_location="cpu",
    )
    state_dict = dict([(a.replace("module.", ""), b) for a, b in state["net"].items()])
    resnet.load_state_dict(state_dict)
    ...
    gtsrbD.load_state_dict(
        torch.load(
            os.path.join(curr_dir, "models/dcgan/gtsrb/netD_epoch_23.pth"),
            map_location="cpu",
        )
    )
    ...
    gtsrbG.load_state_dict(
        torch.load(
            os.path.join(curr_dir, "models/dcgan/gtsrb/netG_epoch_23.pth"),
            map_location="cpu",
        )
    )
